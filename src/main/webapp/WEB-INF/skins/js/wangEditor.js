...
Editor.prototype = {
    ...
    _initDom: function _initDom() {
        ...
        if (textSelector == null) {
            ...
            // 自行创建的，需要配置默认的样式
            $toolbarElem.css('background-color', '#f1f1f1').css('border', '0px solid #ccc');
            $textContainerElem.css('border', '0px solid #ccc').css('border-top', 'none').css('height', '300px');
        } else {
